...
public class RegistrationController {
    ...
    public String register(Model model) {
        ...
        userDTO.setRoleIdCount(Constant.ROLE_USER); // Set the default value for "Student"
    ...
    public String registration(@Valid @ModelAttribute("obj") UserDTO userDTO,
        ...
        Optional<Role> role = rolesRepository
                .findById((userDTO.getRoleIdCount() != null) ? userDTO.getRoleIdCount() : Constant.ROLE_USER);
        ...
        if (role.isPresent()) {
            ...
            manager.setRoleId(Constant.ROLE_TUTOR);
            manager.setName("ROLE_TUTOR");
