...
public class UserProgressService {
    ...
    private UserProgress mapToEntity(final UserProgressDTO userProgressDTO,
        ...
        final User user = userProgressDTO.getUser() == null ? null
                : userRepository.findById(userProgressDTO.getUser())
                        .orElseThrow(() -> new NotFoundException("user not found"));
        userProgress.setUser(user);
        final Course course = userProgressDTO.getCourse() == null ? null
                : courseRepository.findById(userProgressDTO.getCourse())
